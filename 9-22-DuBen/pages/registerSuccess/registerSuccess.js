...
Page({
  ...
  bindGetUserInfo: function(e) {
   ...
   if (e.detail.userInfo) {
    ...
    app.userHead = e.detail.userInfo.avatarUrl;
    app.username = e.detail.userInfo.nickName;
    app.renlianimg = '';
    console.log("userName====="+e.detail.userInfo.nickName+";userHead="+e.detail.userInfo.avatarUrl)
    console.log(";renlianimg====="+app.renlianimg)
    this.setData({
