...
Page({
     ...
     chooseTime:function(e){
          ...
          wx.navigateTo({
               url: '../chooseTime/chooseTime?startMonth='+startMonth+"&startWeek="+startWeek+"&startDay="+startDay+"&endMonth="+endMonth+"&endWeek="+endWeek+"&endDay="+endDay+"&day="+day,
             })
     },
     ...
     bookRoom: function (e) {
          ...
          var startDate = "2020-"+startMonth+"-"+startDay;
          var endDate = "2020-"+endMonth+"-"+endDay;
