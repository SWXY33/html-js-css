...
Page({
  ...
  bookRoom:function(){
    console.log("app.username="+app.username+";app.duration="+app.duration+";app.houseType="+app.houseType+";app.idnumber="+app.idnumber+";app.phone"+app.phone)
    wx.request({//预订房间 
      url: 'https://dubeniot.com/iot-manager/Hotel/reserveRoom?bookingPerson='+app.username+'&duration='+app.duration+'&hotelId='+app.hotelId+'&houseType='+app.houseType+'&idnumber='+app.idnumber+'&phone='+app.phone,
      method: 'POST',
 ...
 formSubmit: function (e) {
  ...
  app.username = FormArray.data.username;
  app.duration = day;
  app.houseType = housetype;
  app.idnumber = FormArray.data.idnumber;
  app.phone = FormArray.data.phone;
...
this.getBaiduToken();
    console.log(options);
    orderapp.hotelId = options.hotelId;
