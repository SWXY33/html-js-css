...
var currentYear = new Date().getFullYear();
  ...
  var hotelId = 160041825383116;//酒店Id
Page({
...
book:function(e){ 
  ...
  wx.navigateTo({
  url: '/pages/order/order?startDate='+startDate+'&endDate=' + endDate+'&day='+day+'&price='+price+'&roomname='+roomname+"&housetype="+housetype+'&hotelName='+hotelName+'&hotelId='+hotelId,
  })
},
  /**
   * 折叠展开动画
   ...
   if(endMonth>startMonth){
    ...
    for(var i=0;i<3;i++){
      ...
      wx.request({//查询房间类型剩余数 (HOUSE_ONE为单间，HOUSE_TWO为双间，HOUSE_BIG为大床房) 
        url: 'https://dubeniot.com/iot-manager/Hotel/getRoomQuantity?hotelId='+hotelId+'&type='+type ,
        method: 'GET',
    ...
    wx.request({//获取房间类型
      url: 'https://dubeniot.com/iot-manager/Hotel/getRoomType?hotelId='+hotelId ,
      method: 'GET',
