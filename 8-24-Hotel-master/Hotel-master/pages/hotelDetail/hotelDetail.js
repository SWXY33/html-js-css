...
Page({
     ...
     chooseTime:function(e){
         console.log("e==="+JSON.stringify(e)) ;
          ...
          wx.navigateTo({
               url: '../chooseTime/chooseTime?startMonth='+startMonth+"&startWeek="+startWeek+"&startDay="+startDay+"&endMonth="+endMonth+"&endWeek="+endWeek+"&endDay="+endDay+"&day="+day+"&startYear="+startYear+"&endYear="+endYear,
             })
     },
