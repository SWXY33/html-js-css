...
Page({
  ...
  bookRoom:function(){
    ...
    wx.request({//预订房间 
      url: 'https://dubeniot.com/iot-manager/Hotel/reserveRoom?bookingPerson='+app.username+'&duration='+app.duration+'&hotelId=160041825383116&houseType='+app.houseType+'&idnumber='+app.idnumber+'&phone='+app.phone,
      method: 'POST',
