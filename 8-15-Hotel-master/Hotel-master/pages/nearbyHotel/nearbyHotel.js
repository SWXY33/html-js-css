...
Page({
     ...
     onLoad: function (options) {
          ...
          var tencentMapKey='XPIBZ-F4S6F-SHHJI-NO25R-R76VF-X6BCB';
          wx.getLocation({
               type: 'gcj02', //返回可以用于wx.openLocation的经纬度
                ...
                console.log("附近酒店：查找到"+wx.getStorageSync('nearbyHotel').length+"个：---------"+JSON.stringify(wx.getStorageSync('nearbyHotel')))
                var nearbyHotels=wx.getStorageSync('nearbyHotel');
          ...
          for (var i = 0; i < nearbyHotels.length; i++) {
               ...
               hotelBean.score = 5.0;
               hotelBean.service = nearbyHotels[i].tel;
